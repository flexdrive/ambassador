...
import (
	...
	envoy_api_v3alpha "github.com/datawire/ambassador/pkg/apis/envoy/api/v3alpha"
)
...
var (
	...
	_ = envoy_api_v3alpha.Cluster_DnsLookupFamily(0)
)
...
func (m *DnsCacheConfig) Validate() error {
	...
	if _, ok := envoy_api_v3alpha.Cluster_DnsLookupFamily_name[int32(m.GetDnsLookupFamily())]; !ok {
		return DnsCacheConfigValidationError{
